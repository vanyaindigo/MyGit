...
public class PersonOverviewController {
    ...
    private void handleDeletePerson() {
        ...
        if (selectedIndex >= 0) {
            ...
            alert.setHeaderText("Не выделена строка");
            alert.setContentText("Пожалуйста, выделите строку в таблице перед удалением.");
            alert.showAndWait();
        }
    }
    /**
    ...
    private void handleEditPerson() {
        ...
        if (selectedPerson != null) {
            ...
            alert.setTitle("Нет выделения");
            alert.setHeaderText("Не выделена строка");
            alert.setContentText("Пожалуйста, выделите строку в таблице перед редактированием.");
            alert.showAndWait();
        }
    }
}